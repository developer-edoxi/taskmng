...
<head>
  <meta charset="utf-8">
	...
	<link rel="stylesheet" href="<?=base_url()?>src/css/pages/forum.css">
            ...
            <?php
                ...
                <div class="box">
                        <div class="box-header no-border p-0">				
                            <a href="#">
                            <img class="img-fluid" src="<?=$value->img?>" alt="" height="100px" width="100px">
                            </a>
                        </div>
				        <div class="box-body">
					        <div class="text-center">
                                ...
                                <i class="icon-Chat comment-icon" tpid="<?=$value->id?>" style="font-size: 32px;"><span class="path1"></span><span class="path2"></span></i>
                            
					        </div>
							<div class="comment-section" id="cs<?=$value->id?>">
...
<script type="text/javascript" src="https://cdn.datatables.net/1.13.5/js/dataTables.bootstrap4.min.js"></script>
	...
	<script src="<?=base_url()?>src/js/pages/forum.js"></script>
...
function viewcomment(topicid) {
	...
	var commentview = document.querySelector("#cs"+topicid+">.comment-view");
