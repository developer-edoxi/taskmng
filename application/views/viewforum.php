...
<head>
  <meta charset="utf-8">
	...
	<link rel="stylesheet" href="<?=base_url()?>src/css/pages/viewforum.css">
...
<div class="wrapper">
			...
			<ul class="nav navbar-nav">
				...
				<li class="btn-group">
					<a href="#" class="waves-effect waves-light nav-link btn-primary-light svg-bt-icon dropdown-toggle" data-bs-toggle="dropdown">
						<img class="rounded" src="<?=base_url()?>images/logo-letter.png" alt="">
					</a>
  ...
  <nav class="main-nav" role="navigation">
      ...
      <li><a class='forward'><i class="icon-Layout-4-blocks"><span class="path1"></span><span class="path2"></span></i>Post</a></li>
				...
				<div class="col-lg-4 col-12">
                    ...
                    <div class="box">
                        <div class="box-header no-border p-0">				
                            <a href="#">
                            <img class="img-fluid" src="<?=base_url().$value->img?>" alt="">
                            </a>
                        </div>
				        <div class="box-body">
					        <div class="text-center">
							<input type="hidden" id="userslug" value=<?=$slug?>  required>
                                <h3 class="my-10"><a href="#"><?=$value->caption?></a></h3>
                                
                                <p class="text-fade w-p85 mx-auto"><?=$value->description?> </p>
                                <i class="icon-Chat comment-icon" id="<?=$count?>" tpid="<?=$value->topicid?>" stat="<?=$value->status?>" style="font-size: 32px;" ><span class="path1"></span><span class="path2"></span></i>
								<?php      if(($userid[$count-1]==$slug) and ($status[$count-1])=='opened'){ ?>
								<i class="icon-Close close-icon"  tpid="<?=$value->topicid?>"  style="font-size: 32px;" title="Do you want to close the discussion!"><span class="path1"></span><span class="path2"></span></i>
								<?php  }  ?>
					        </div>
                            
                            <div class="comment-section" id="cs<?=$count?>" stat="<?=$value->status?>">
								<hr>
								<form class="form-part">
										<div class="input-group">
										<input type="text" class="form-control" id="cm<?=$value->topicid?>"  placeholder="Add a comment" required>
										<span class="input-group-text"><i class="icon-Send comment-sent" id="<?=$count?>" tpid="<?=$value->topicid?>" dataval="<?=$value->uid?>"><span class="path1"></span><span class="path2"></span></i></span>
										</div>
								</form>
...
<div class="modal-content">
	...
	<div class="demo">
		...
		<form class="form" action="<?=base_url('Welcome/addtopdiscuss')?>" method="POST" enctype="multipart/form-data">
									<div class="box-body">
										...
										<input type="text" class="form-control" placeholder="Topic" name="caption">
										</div>
										<input type="hidden" class="form-control" value=<?=$slug?> name="uid">
										<div class="form-group">
										<textarea class="form-control" rows="3" placeholder="Topic Description" name="description"></textarea>
										</div>
										<div class="form-group">
											<label class="form-label">Add Users to the discussion</label>
										...
										<div class="image-upload">
											<label for="file-input">
												<img src="<?=base_url()?>images/imgicon.png" height="70px" width="50px"/>
											</label>
...
<script type="text/javascript" src="https://cdn.datatables.net/1.13.5/js/dataTables.bootstrap4.min.js"></script>
	...
	<script src="<?=base_url()?>src/js/pages/viewforum.js"></script>
